source("Plot2.R") ## creates function plotPlot2
source("Plot3.R") ## creates function plotPlot3
...
plot(
  ...
  householdPowerConsumption$Voltage,
  type = "l",
  xlab = "datetime",
  ylab = "Voltage"
)
plot(
  householdPowerConsumption$DateTime,
  householdPowerConsumption$Global_reactive_power,
  type = "l",
  xlab = "datetime",
